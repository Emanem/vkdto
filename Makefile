...
LIBS=
OBJS=$(OBJDIR)/overlay_params.o $(OBJDIR)/overlay.o $(OBJDIR)/hash_table.o $(OBJDIR)/u_atomic.o $(OBJDIR)/u_math.o $(OBJDIR)/ralloc.o $(OBJDIR)/u_debug.o $(OBJDIR)/vk_enum_to_str.o $(OBJDIR)/imgui_draw.o $(OBJDIR)/os_misc.o $(OBJDIR)/os_socket.o $(OBJDIR)/os_time.o $(OBJDIR)/imgui.o $(OBJDIR)/bitscan.o $(OBJDIR)/u_cpu_detect.o $(OBJDIR)/vk_util.o $(OBJDIR)/imgui_widgets.o 
EXEC=vkdto.so
...
$(OBJDIR)/overlay.o: src/overlay.cpp src/imgui.h src/imconfig.h \
 ...
 src/macros.h src/c11_compat.h src/list.h src/ralloc.h src/os_time.h \
 src/os_socket.h src/simple_mtx.h src/futex.h src/threads.h \
