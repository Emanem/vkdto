...
SRCDIR=src
OBJDIR=obj
CFLAGS=-g -Wall -pthread -fPIC -shared
CPPFLAGS=-g -Wall -std=c++11 -pthread -fPIC -shared
LIBS=
...
$(EXEC) : $(OBJS)
	$(LINK) $(OBJS) -o $(EXEC) $(CPPFLAGS) $(LIBS)

$(OBJDIR)/overlay.o: src/overlay.cpp src/imgui.h src/imconfig.h src/hash_table.h \
 src/c99_compat.h src/no_extern_c.h src/macros.h src/c11_compat.h \
 src/list.h src/ralloc.h src/simple_mtx.h src/futex.h src/threads.h \
 src/threads_posix.h src/vk_enum_to_str.h src/vk_util.h \
 src/hashtext_fmt.h src/overlay.vert.spv.h src/overlay.frag.spv.h $(OBJDIR)/__setup_obj_dir
	$(CPPC) $(CPPFLAGS) src/overlay.cpp -c -o $@
...
$(OBJDIR)/hash_table.o: src/hash_table.c src/hash_table.h src/c99_compat.h \
 ...
 src/fast_urem_by_const.h src/xxhash.h $(OBJDIR)/__setup_obj_dir
	$(CC) $(CFLAGS) src/hash_table.c -c -o $@
...
$(OBJDIR)/vk_enum_to_str.o: src/vk_enum_to_str.c src/macros.h src/c99_compat.h \
 src/no_extern_c.h src/c11_compat.h src/vk_enum_to_str.h $(OBJDIR)/__setup_obj_dir
	$(CC) $(CFLAGS) src/vk_enum_to_str.c -c -o $@
...
$(OBJDIR)/imgui_widgets.o: src/imgui_widgets.cpp src/imgui.h src/imconfig.h \
 src/imgui_internal.h src/imstb_textedit.h $(OBJDIR)/__setup_obj_dir
	$(CPPC) $(CFLAGS) src/imgui_widgets.cpp -c -o $@
